...
if __name__=='__main__':
    ...
    lr = PolynomialRegression(loss=MSE, learning_rate=LEARNING_RATE, scheduler_fn=scheduler, degree=2, penalty=lasso)
    ...
    # sklearn_ridge  = Ridge(alpha=0.9)
    # sklearn_ridge.fit(X, y)
    # print(sklearn_ridge.intercept_, sklearn_ridge.coef_[0])
